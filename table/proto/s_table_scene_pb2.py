...
_SCENE = descriptor.Descriptor(
  ...
  fields=[
    ...
    descriptor.FieldDescriptor(
      ...
      options=None),
    descriptor.FieldDescriptor(
      name='res', full_name='table.scene.res', index=2,
      ...
      options=None),
    descriptor.FieldDescriptor(
      name='num_uint32', full_name='table.scene.num_uint32', index=3,
      ...
      options=None),
    descriptor.FieldDescriptor(
      name='num_float', full_name='table.scene.num_float', index=4,
