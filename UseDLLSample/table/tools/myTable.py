...
class MyType(object):
    ...
    @classmethod
    def load_user_type(cls):
        with xlrd.open_workbook(config.user_type_table_path) as table:
            global USER_TYPE_DATA
            USER_TYPE_DATA = table.sheets()[0]
